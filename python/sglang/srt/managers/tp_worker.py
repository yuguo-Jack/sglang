...
class TpModelWorker:
    ...
    def forward_batch_generation(self, model_worker_batch: ModelWorkerBatch, gap_decode_schedule = None):
        forward_batch = ForwardBatch.init_new(model_worker_batch, self.model_runner)
        logits_output = self.model_runner.forward(forward_batch, gap_decode_schedule)
